...
type
  TicToolLcdFloodfill = class(TicTool)
  private
...
constructor TicToolLcdFloodfill.Create(AOwner: TComponent);
begin
  inherited;
  Cursor := crCross;
end;

procedure TicToolLcdFloodfill.MouseDown(Sender: TicPaintBox;
...
begin
  ...
  begin
    LCmd := TicCmdLayer_Modify.Create(GIntegrator.ActivePaintBox.UndoRedo);
