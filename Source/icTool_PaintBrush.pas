...
type
  ...
  TicPaintBrush = class(TicCustomBrush)
  private
    FColor : TColor32;
  protected
...
constructor TicPaintBrush.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TicPaintBrush.Paint(ADestBmp: TBitmap32; const AX, AY: Integer);
var
  i, j           : Integer;
  LPaintX        : Integer;
  LPaintY        : Integer;
